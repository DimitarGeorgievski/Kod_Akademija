...
AS SELECT e.emp_id, e.name, d.dept_name FROM employees e
...
AS SELECT d.dept_name, COUNT(*) AS emp_count FROM departments d
...
-- UPDATE THE NOTE COLUMN (INSERT INTO... VALUES)(UPDATE...SET)
